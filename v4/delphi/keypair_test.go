...
func deterministicKeyPair(t testing.TB, seed uint64) KeyPair {
	t.Helper()
	cryptotest.SetGlobalRandom(t.(*testing.T), seed)
	kp := NewKeyPair()
	return kp
}
...
func TestKeyPair_String(t *testing.T) {
	kp := deterministicKeyPair(t, 1)
	assert.Equal(t, "", kp.String())
}
