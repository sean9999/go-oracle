...
func TestCipherText_pem(t *testing.T) {
	...
	t.Run("Marshal PEM", func(t *testing.T) {
		...
		ionData, err := cryptMsg.MarshalPEM()
		if err != nil {
			t.Error(err)
		}
